...
\hypersetup{
    ...
    pdftitle={Jelato: A Distributed Online Marketplace for Ice Cream Flavours},
    pdfauthor={Team Members},
    pdfsubject={Comprehensive Project Report},
    pdfkeywords={distributed systems, online marketplace, ice cream}
}
